  ...
  static Product? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        ...
        assert(json.containsKey(r'productCode'), 'Required key "Product[productCode]" is missing from JSON.');
        assert(json[r'productCode'] != null, 'Required key "Product[productCode]" has a null value in JSON.');
        assert(json.containsKey(r'sku'), 'Required key "Product[sku]" is missing from JSON.');
        assert(json[r'sku'] != null, 'Required key "Product[sku]" has a null value in JSON.');
        return true;
      }());
