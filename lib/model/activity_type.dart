...
enum ActivityType {
  ...
  /// Returns the instance of [ActivityType] that was successfully decoded
  /// from the passed [value] on success, null otherwise.
  static ActivityType? fromJson(dynamic value) => ActivityTypeTypeTransformer().decode(value);

  /// Returns a [List] containing instances of [ActivityType]
...
class ActivityTypeTypeTransformer {
  ...
  /// Encodes this enum as a value suitable for JSON.
  String encode(ActivityType data) => data._value;
  ...
  ActivityType? decode(dynamic data, {bool allowNull = true}) {
    ...
    if (data != null) {
      switch (data) {
        case r'call': return ActivityType.call;
        case r'email': return ActivityType.email;
        case r'meeting': return ActivityType.meeting;
        case r'task': return ActivityType.task;
        case r'note': return ActivityType.note;
        default:
          if (!allowNull) {
