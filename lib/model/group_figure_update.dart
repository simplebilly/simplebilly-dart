...
class GroupFigureUpdate {
  /// Returns a new [GroupFigureUpdate] instance.
  GroupFigureUpdate({
    this.bilanzsumme,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GroupFigureUpdate &&
  ...
  @override
  String toString() => 'GroupFigureUpdate[bilanzsumme=$bilanzsumme, exemptionClaimed=$exemptionClaimed, mitarbeiter=$mitarbeiter, nettoUmsatz=$nettoUmsatz, parentName=$parentName, parentSitus=$parentSitus]';
  ...
  /// Returns a new [GroupFigureUpdate] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GroupFigureUpdate? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<GroupFigureUpdate> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <GroupFigureUpdate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GroupFigureUpdate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GroupFigureUpdate> mapFromJson(dynamic json) {
    final map = <String, GroupFigureUpdate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GroupFigureUpdate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of GroupFigureUpdate-objects as value to a dart map
  static Map<String, List<GroupFigureUpdate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GroupFigureUpdate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GroupFigureUpdate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
