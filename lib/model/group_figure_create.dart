...
class GroupFigureCreate {
  /// Returns a new [GroupFigureCreate] instance.
  GroupFigureCreate({
    this.bilanzsumme,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GroupFigureCreate &&
  ...
  @override
  String toString() => 'GroupFigureCreate[bilanzsumme=$bilanzsumme, exemptionClaimed=$exemptionClaimed, mitarbeiter=$mitarbeiter, nettoUmsatz=$nettoUmsatz, parentName=$parentName, parentSitus=$parentSitus]';
  ...
  /// Returns a new [GroupFigureCreate] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GroupFigureCreate? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<GroupFigureCreate> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <GroupFigureCreate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GroupFigureCreate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GroupFigureCreate> mapFromJson(dynamic json) {
    final map = <String, GroupFigureCreate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GroupFigureCreate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of GroupFigureCreate-objects as value to a dart map
  static Map<String, List<GroupFigureCreate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GroupFigureCreate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GroupFigureCreate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
