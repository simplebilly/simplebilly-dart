...
class KycRecord {
  /// Returns a new [KycRecord] instance.
  KycRecord({
    this.customerId,
    this.customerName,
    this.kycDate,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is KycRecord &&
  ...
  @override
  String toString() => 'KycRecord[customerId=$customerId, customerName=$customerName, kycDate=$kycDate, notes=$notes, retentionUntil=$retentionUntil, riskAssessment=$riskAssessment]';
  ...
  /// Returns a new [KycRecord] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static KycRecord? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<KycRecord> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <KycRecord>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = KycRecord.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, KycRecord> mapFromJson(dynamic json) {
    final map = <String, KycRecord>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = KycRecord.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of KycRecord-objects as value to a dart map
  static Map<String, List<KycRecord>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<KycRecord>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = KycRecord.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
