...
class InvoiceCreate {
  /// Returns a new [InvoiceCreate] instance.
  InvoiceCreate({
    this.attachments,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InvoiceCreate &&
  ...
  /// Returns a new [InvoiceCreate] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static InvoiceCreate? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'currency'), 'Required key "InvoiceCreate[currency]" is missing from JSON.');
        assert(json[r'currency'] != null, 'Required key "InvoiceCreate[currency]" has a null value in JSON.');
        assert(json.containsKey(r'invoiceType'), 'Required key "InvoiceCreate[invoiceType]" is missing from JSON.');
        assert(json[r'invoiceType'] != null, 'Required key "InvoiceCreate[invoiceType]" has a null value in JSON.');
        assert(json.containsKey(r'issueDate'), 'Required key "InvoiceCreate[issueDate]" is missing from JSON.');
        assert(json[r'issueDate'] != null, 'Required key "InvoiceCreate[issueDate]" has a null value in JSON.');
        assert(json.containsKey(r'lineItems'), 'Required key "InvoiceCreate[lineItems]" is missing from JSON.');
        assert(json.containsKey(r'status'), 'Required key "InvoiceCreate[status]" is missing from JSON.');
        assert(json[r'status'] != null, 'Required key "InvoiceCreate[status]" has a null value in JSON.');
        assert(json.containsKey(r'subtotal'), 'Required key "InvoiceCreate[subtotal]" is missing from JSON.');
        assert(json[r'subtotal'] != null, 'Required key "InvoiceCreate[subtotal]" has a null value in JSON.');
        assert(json.containsKey(r'totalAmount'), 'Required key "InvoiceCreate[totalAmount]" is missing from JSON.');
        assert(json[r'totalAmount'] != null, 'Required key "InvoiceCreate[totalAmount]" has a null value in JSON.');
        assert(json.containsKey(r'totalTax'), 'Required key "InvoiceCreate[totalTax]" is missing from JSON.');
        assert(json[r'totalTax'] != null, 'Required key "InvoiceCreate[totalTax]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<InvoiceCreate> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InvoiceCreate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InvoiceCreate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, InvoiceCreate> mapFromJson(dynamic json) {
    final map = <String, InvoiceCreate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = InvoiceCreate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of InvoiceCreate-objects as value to a dart map
  static Map<String, List<InvoiceCreate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InvoiceCreate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InvoiceCreate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
