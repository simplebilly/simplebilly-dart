...
enum JobStatus {
  ...
  /// Returns the instance of [JobStatus] that was successfully decoded
  /// from the passed [value] on success, null otherwise.
  static JobStatus? fromJson(dynamic value) => JobStatusTypeTransformer().decode(value);

  /// Returns a [List] containing instances of [JobStatus]
...
class JobStatusTypeTransformer {
  ...
  /// Encodes this enum as a value suitable for JSON.
  String encode(JobStatus data) => data._value;
  ...
  JobStatus? decode(dynamic data, {bool allowNull = true}) {
    ...
    if (data != null) {
      switch (data) {
        ...
        case r'done': return JobStatus.done;
