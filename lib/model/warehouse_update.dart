...
class WarehouseUpdate {
  /// Returns a new [WarehouseUpdate] instance.
  WarehouseUpdate({
    this.addressCity,
    this.addressCountry,
    this.addressStreet,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is WarehouseUpdate &&
  ...
  @override
  String toString() => 'WarehouseUpdate[addressCity=$addressCity, addressCountry=$addressCountry, addressStreet=$addressStreet, addressZip=$addressZip, binLocations=$binLocations, code=$code, isActive=$isActive, isDefault=$isDefault, name=$name, notes=$notes]';
  ...
  /// Returns a new [WarehouseUpdate] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static WarehouseUpdate? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<WarehouseUpdate> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <WarehouseUpdate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = WarehouseUpdate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, WarehouseUpdate> mapFromJson(dynamic json) {
    final map = <String, WarehouseUpdate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = WarehouseUpdate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of WarehouseUpdate-objects as value to a dart map
  static Map<String, List<WarehouseUpdate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<WarehouseUpdate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = WarehouseUpdate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
