...
class ServiceAssignmentCreate {
  /// Returns a new [ServiceAssignmentCreate] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ServiceAssignmentCreate &&
  ...
  @override
  String toString() => 'ServiceAssignmentCreate[employeeId=$employeeId, jobId=$jobId, notes=$notes, scheduledDate=$scheduledDate, scheduledEnd=$scheduledEnd, scheduledStart=$scheduledStart, status=$status]';
  ...
  /// Returns a new [ServiceAssignmentCreate] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ServiceAssignmentCreate? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ServiceAssignmentCreate> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ServiceAssignmentCreate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ServiceAssignmentCreate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ServiceAssignmentCreate> mapFromJson(dynamic json) {
    final map = <String, ServiceAssignmentCreate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ServiceAssignmentCreate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ServiceAssignmentCreate-objects as value to a dart map
  static Map<String, List<ServiceAssignmentCreate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ServiceAssignmentCreate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ServiceAssignmentCreate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
