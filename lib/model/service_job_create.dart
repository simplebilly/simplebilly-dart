...
class ServiceJobCreate {
  /// Returns a new [ServiceJobCreate] instance.
  ServiceJobCreate({
    this.address,
    this.customerEmail,
    this.customerId,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ServiceJobCreate &&
  ...
  @override
  String toString() => 'ServiceJobCreate[address=$address, customerEmail=$customerEmail, customerId=$customerId, customerName=$customerName, customerPhone=$customerPhone, description=$description, estimatedDurationMinutes=$estimatedDurationMinutes, lat=$lat, lng=$lng, notes=$notes, status=$status]';
  ...
  /// Returns a new [ServiceJobCreate] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ServiceJobCreate? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ServiceJobCreate> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ServiceJobCreate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ServiceJobCreate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ServiceJobCreate> mapFromJson(dynamic json) {
    final map = <String, ServiceJobCreate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ServiceJobCreate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ServiceJobCreate-objects as value to a dart map
  static Map<String, List<ServiceJobCreate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ServiceJobCreate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ServiceJobCreate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
