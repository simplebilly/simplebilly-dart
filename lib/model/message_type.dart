...
enum MessageType {
  ...
  /// Returns the instance of [MessageType] that was successfully decoded
  /// from the passed [value] on success, null otherwise.
  static MessageType? fromJson(dynamic value) => MessageTypeTypeTransformer().decode(value);

  /// Returns a [List] containing instances of [MessageType]
...
class MessageTypeTypeTransformer {
  ...
  /// Encodes this enum as a value suitable for JSON.
  String encode(MessageType data) => data._value;
  ...
  MessageType? decode(dynamic data, {bool allowNull = true}) {
    ...
    if (data != null) {
      switch (data) {
        ...
        case r'html': return MessageType.html;
        default:
          if (!allowNull) {
