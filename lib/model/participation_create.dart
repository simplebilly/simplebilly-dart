...
class ParticipationCreate {
  /// Returns a new [ParticipationCreate] instance.
  ParticipationCreate({
    this.acquiredAt,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ParticipationCreate &&
  ...
  @override
  String toString() => 'ParticipationCreate[acquiredAt=$acquiredAt, boardAppointment=$boardAppointment, companyName=$companyName, controlAgreement=$controlAgreement, legalForm=$legalForm, ownershipPct=$ownershipPct, purposeVehicle=$purposeVehicle, votingMajority=$votingMajority]';
  ...
  /// Returns a new [ParticipationCreate] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ParticipationCreate? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ParticipationCreate> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ParticipationCreate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ParticipationCreate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ParticipationCreate> mapFromJson(dynamic json) {
    final map = <String, ParticipationCreate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ParticipationCreate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ParticipationCreate-objects as value to a dart map
  static Map<String, List<ParticipationCreate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ParticipationCreate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ParticipationCreate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
