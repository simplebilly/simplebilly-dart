...
class PriceTier {
  ...
  @override
  String toString() => 'PriceTier[customerGroupId=$customerGroupId, minQuantity=$minQuantity, productId=$productId, unitPrice=$unitPrice]';
  ...
  static PriceTier? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'productId'), 'Required key "PriceTier[productId]" is missing from JSON.');
        assert(json[r'productId'] != null, 'Required key "PriceTier[productId]" has a null value in JSON.');
        assert(json.containsKey(r'unitPrice'), 'Required key "PriceTier[unitPrice]" is missing from JSON.');
        assert(json[r'unitPrice'] != null, 'Required key "PriceTier[unitPrice]" has a null value in JSON.');
        return true;
      }());
