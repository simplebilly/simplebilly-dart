...
class ForgotPasswordRequest {
  ...
  static ForgotPasswordRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'email'), 'Required key "ForgotPasswordRequest[email]" is missing from JSON.');
        assert(json[r'email'] != null, 'Required key "ForgotPasswordRequest[email]" has a null value in JSON.');
        return true;
      }());
