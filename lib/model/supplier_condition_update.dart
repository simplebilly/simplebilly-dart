...
class SupplierConditionUpdate {
  /// Returns a new [SupplierConditionUpdate] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SupplierConditionUpdate &&
  ...
  /// Returns a new [SupplierConditionUpdate] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SupplierConditionUpdate? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<SupplierConditionUpdate> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SupplierConditionUpdate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SupplierConditionUpdate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SupplierConditionUpdate> mapFromJson(dynamic json) {
    final map = <String, SupplierConditionUpdate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SupplierConditionUpdate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SupplierConditionUpdate-objects as value to a dart map
  static Map<String, List<SupplierConditionUpdate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SupplierConditionUpdate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SupplierConditionUpdate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
