...
class OrderCreate {
  ...
  static OrderCreate? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'currency'), 'Required key "OrderCreate[currency]" is missing from JSON.');
        assert(json[r'currency'] != null, 'Required key "OrderCreate[currency]" has a null value in JSON.');
        assert(json.containsKey(r'customerId'), 'Required key "OrderCreate[customerId]" is missing from JSON.');
        assert(json[r'customerId'] != null, 'Required key "OrderCreate[customerId]" has a null value in JSON.');
        assert(json.containsKey(r'orderStatus'), 'Required key "OrderCreate[orderStatus]" is missing from JSON.');
        assert(json[r'orderStatus'] != null, 'Required key "OrderCreate[orderStatus]" has a null value in JSON.');
        assert(json.containsKey(r'paymentMethod'), 'Required key "OrderCreate[paymentMethod]" is missing from JSON.');
        assert(json[r'paymentMethod'] != null, 'Required key "OrderCreate[paymentMethod]" has a null value in JSON.');
        assert(json.containsKey(r'shippingCost'), 'Required key "OrderCreate[shippingCost]" is missing from JSON.');
        assert(json[r'shippingCost'] != null, 'Required key "OrderCreate[shippingCost]" has a null value in JSON.');
        assert(json.containsKey(r'shippingMethod'), 'Required key "OrderCreate[shippingMethod]" is missing from JSON.');
        assert(json[r'shippingMethod'] != null, 'Required key "OrderCreate[shippingMethod]" has a null value in JSON.');
        assert(json.containsKey(r'shippingWeight'), 'Required key "OrderCreate[shippingWeight]" is missing from JSON.');
        assert(json[r'shippingWeight'] != null, 'Required key "OrderCreate[shippingWeight]" has a null value in JSON.');
        assert(json.containsKey(r'tags'), 'Required key "OrderCreate[tags]" is missing from JSON.');
        assert(json[r'tags'] != null, 'Required key "OrderCreate[tags]" has a null value in JSON.');
        assert(json.containsKey(r'totalCost'), 'Required key "OrderCreate[totalCost]" is missing from JSON.');
        assert(json[r'totalCost'] != null, 'Required key "OrderCreate[totalCost]" has a null value in JSON.');
        return true;
      }());
