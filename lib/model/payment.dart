...
class Payment {
  ...
  @override
  String toString() => 'Payment[amount=$amount, attachment=$attachment, currency=$currency, customerId=$customerId, description=$description, metadata=$metadata, method=$method, paymentDate=$paymentDate, reference=$reference]';
