...
// tests for EmployeeUpdate
void main() {
  // final instance = EmployeeUpdate();

  group('test EmployeeUpdate', () {
    // String address
    ...
    test('to test the property `backupEmployeeId`', () async {
      // TODO
    });
    ...
    test('to test the property `monthlySalary`', () async {
      // TODO
    });
    ...
    // String weeklyHours
    test('to test the property `weeklyHours`', () async {
      // TODO
    });
