...
// tests for WarehouseUpdate
void main() {
  // final instance = WarehouseUpdate();

  group('test WarehouseUpdate', () {
    // String addressCity
    ...
    test('to test the property `addressStreet`', () async {
      // TODO
    });
    ...
    // Object binLocations
    test('to test the property `binLocations`', () async {
      // TODO
    });
