...
// tests for CustomerGroupCreate
void main() {
  // final instance = CustomerGroupCreate();

  group('test CustomerGroupCreate', () {
    // String description
    ...
    // List<String> memberIds (default value: const [])
    ...
    test('to test the property `membershipFilter`', () async {
      // TODO
    });
