...
// tests for ApiResponseSubscriptionOverviewData
void main() {
  // final instance = ApiResponseSubscriptionOverviewData();

  group('test ApiResponseSubscriptionOverviewData', () {
    ...
    // bool isTrialing
    test('to test the property `isTrialing`', () async {
      // TODO
    });
    ...
    // String manageUrl
    test('to test the property `manageUrl`', () async {
      // TODO
    });
    ...
    // double priceEur
    test('to test the property `priceEur`', () async {
      // TODO
    });
    ...
    test('to test the property `trialEndsAt`', () async {
      // TODO
    });
