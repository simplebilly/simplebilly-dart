...
// tests for JobPostingCreate
void main() {
  // final instance = JobPostingCreate();

  group('test JobPostingCreate', () {
    // String currency
    ...
    test('to test the property `requiredSkills`', () async {
      // TODO
    });
    ...
    // int salaryMax
    test('to test the property `salaryMax`', () async {
      // TODO
    });

    // int salaryMin
    test('to test the property `salaryMin`', () async {
      // TODO
    });
