...
// tests for ShippingRuleCreate
void main() {
  // final instance = ShippingRuleCreate();

  group('test ShippingRuleCreate', () {
    ...
    // double maxWeightKg
    test('to test the property `maxWeightKg`', () async {
      // TODO
    });

    // double minWeightKg
    test('to test the property `minWeightKg`', () async {
      // TODO
    });
