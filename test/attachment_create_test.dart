...
// tests for AttachmentCreate
void main() {
  // final instance = AttachmentCreate();

  group('test AttachmentCreate', () {
    ...
    // String pdfaPath
    test('to test the property `pdfaPath`', () async {
      // TODO
    });

    // String sha256Hash
    test('to test the property `sha256Hash`', () async {
      // TODO
    });
