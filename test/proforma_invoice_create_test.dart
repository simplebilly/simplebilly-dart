...
// tests for ProformaInvoiceCreate
void main() {
  // final instance = ProformaInvoiceCreate();

  group('test ProformaInvoiceCreate', () {
    ...
    test('to test the property `convertedToInvoiceId`', () async {
      // TODO
    });
    ...
    test('to test the property `customerSnapshot`', () async {
      // TODO
    });
