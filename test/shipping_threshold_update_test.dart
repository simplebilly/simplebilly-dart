...
// tests for ShippingThresholdUpdate
void main() {
  // final instance = ShippingThresholdUpdate();

  group('test ShippingThresholdUpdate', () {
    // bool isActive
    ...
    // int maxSellable
    test('to test the property `maxSellable`', () async {
      // TODO
    });
    ...
    // int reserveStock
    test('to test the property `reserveStock`', () async {
      // TODO
    });
