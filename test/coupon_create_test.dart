...
// tests for CouponCreate
void main() {
  // final instance = CouponCreate();

  group('test CouponCreate', () {
    // String code
    ...
    // bool isCombineable
    test('to test the property `isCombineable`', () async {
      // TODO
    });
    ...
    test('to test the property `maxUsesPerCustomer`', () async {
      // TODO
    });
