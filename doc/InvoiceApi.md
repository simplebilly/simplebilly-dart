# simplebilly_api.api.InvoiceApi
...
final invoiceCreate = InvoiceCreate(); // InvoiceCreate | 

try {
    final result = api_instance.createInvoice(invoiceCreate);
    print(result);
} catch (e) {
...
try {
    api_instance.downloadInvoicePdf(id);
} catch (e) {
    print('Exception when calling InvoiceApi->downloadInvoicePdf: $e\n');
}
```
...
try {
    final result = api_instance.getInvoice(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getInvoicePdfUrl(id);
    print(result);
} catch (e) {
    print('Exception when calling InvoiceApi->getInvoicePdfUrl: $e\n');
}
```
...
# **getInvoices**
> List<Invoice> getInvoices(page, pageSize, search, includeDeleted)
...
try {
    final result = api_instance.getInvoices(page, pageSize, search, includeDeleted);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.invoiceRestore(id);
    print(result);
} catch (e) {
    print('Exception when calling InvoiceApi->invoiceRestore: $e\n');
}
```
...
try {
    final result = api_instance.updateInvoice(id, body);
    print(result);
} catch (e) {
    print('Exception when calling InvoiceApi->updateInvoice: $e\n');
}
```
