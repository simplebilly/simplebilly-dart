...
final api_instance = EuerApi();
final year = 56; // int | 

try {
    final result = api_instance.euerApi(year);
    print(result);
} catch (e) {
    print('Exception when calling EuerApi->euerApi: $e\n');
}
```
...
try {
    final result = api_instance.euerKategorienApi(year);
    print(result);
} catch (e) {
    print('Exception when calling EuerApi->euerKategorienApi: $e\n');
}
```
