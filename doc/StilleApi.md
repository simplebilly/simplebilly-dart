...
final api_instance = StilleApi();
final year = 56; // int | 

try {
    final result = api_instance.stilleExportApi(year);
    print(result);
} catch (e) {
    print('Exception when calling StilleApi->stilleExportApi: $e\n');
}
```
...
try {
    final result = api_instance.stilleReportApi(year);
    print(result);
} catch (e) {
    print('Exception when calling StilleApi->stilleReportApi: $e\n');
}
```
