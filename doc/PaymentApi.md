# simplebilly_api.api.PaymentApi
...
try {
    final result = api_instance.createPayment(paymentCreate);
    print(result);
} catch (e) {
...
try {
    api_instance.deletePayment(id);
} catch (e) {
    print('Exception when calling PaymentApi->deletePayment: $e\n');
}
```
...
# **getPayments**
> List<Payment> getPayments(page, pageSize, search, includeDeleted)
...
try {
    final result = api_instance.getPayments(page, pageSize, search, includeDeleted);
    print(result);
} catch (e) {
    print('Exception when calling PaymentApi->getPayments: $e\n');
}
```
...
try {
    final result = api_instance.paymentRestore(id);
    print(result);
} catch (e) {
    print('Exception when calling PaymentApi->paymentRestore: $e\n');
}
```
...
try {
    final result = api_instance.updatePayment(id, body);
    print(result);
} catch (e) {
    print('Exception when calling PaymentApi->updatePayment: $e\n');
}
```
